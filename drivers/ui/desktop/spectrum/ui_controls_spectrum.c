...
static void ui_controls_spectrum_wf_repaint_big(void)
{
	...
	//
	GUI_CopyRect(	(WATERFALL_X + WATERFALL_X_SIZE +  0),		// Upper left X-position of the source rectangle.
					(WATERFALL_Y + WATERFALL_Y_SIZE +  0),		// Upper left Y-position of the source rectangle.
					(WATERFALL_X + WATERFALL_X_SIZE +  0),		// Upper left X-position of the destination rectangle.
