...
const GUI_BITMAP * about[] = {
  &bmgeneralinfoA,   &bmgeneralinfoA,   &bmgeneralinfoA,   &bmgeneralinfoA, &bmgeneralinfoA
};
...
K_ModuleItem_Typedef  about_board =
{
  0,
  "System Information",
  about,
...
static void about_print_fw_vers(WM_HWIN hItem)
{
    ...
    sprintf(p," v %d.%d.%d.%d",MCHFX_VER_MAJOR,MCHFX_VER_MINOR,MCHFX_VER_RELEASE,MCHFX_VER_BUILD);
    ExitCriticalSection();
